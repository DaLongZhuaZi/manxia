...
public final class ThemeInfo$$serializer implements GeneratedSerializer<ThemeInfo> {
    ...
    static {
        ...
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("eu.kanade.tachiyomi.extension.zh.copymanga.api.dto.ThemeInfo", themeInfo$$serializer, 2);
    ...
    public ThemeInfo m49deserialize(Decoder decoder) throws UnknownFieldException {
        ...
        return new ThemeInfo(i, strDecodeStringElement, strDecodeStringElement2, serializationConstructorMarker);
    }
    ...
    public void serialize(Encoder encoder, ThemeInfo value) {
        ...
        ThemeInfo.write$Self(value, compositeEncoderBeginStructure, descriptor2);
