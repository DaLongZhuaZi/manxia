...
public final /* data */ class ComicDetail {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((((((i + r12) * 31) + this.ban) * 31) + this.name.hashCode()) * 31) + this.alias.hashCode()) * 31) + this.pathWord.hashCode()) * 31;
        ...
        int iHashCode3 = (((((((((((((((((((((((((i3 + (freeType == null ? 0 : freeType.hashCode())) * 31) + this.restrict.hashCode()) * 31) + this.reclass.hashCode()) * 31) + this.females.hashCode()) * 31) + this.males.hashCode()) * 31) + this.clubs.hashCode()) * 31) + this.seoBaidu.hashCode()) * 31) + this.region.hashCode()) * 31) + this.status.hashCode()) * 31) + this.author.hashCode()) * 31) + this.theme.hashCode()) * 31) + this.parodies.hashCode()) * 31) + this.brief.hashCode()) * 31;
    ...
    /* JADX INFO: compiled from: ComicDetailResult.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, d2 = {"Leu/kanade/tachiyomi/extension/zh/copymanga/api/dto/ComicDetail$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Leu/kanade/tachiyomi/extension/zh/copymanga/api/dto/ComicDetail;", "tachiyomi-zh.copymanga-v1.4.82_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
