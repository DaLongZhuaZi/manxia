...
public final class ApiRepo {
    ...
    /* JADX INFO: renamed from: RATE_LIMIT_DOMAIN$delegate, reason: from kotlin metadata */
    ...
    public final String mangaCommentUrl(String comicId, int limit, int offset) {
        ...
        if (ApiDomainOption.INSTANCE.isHotManga(getApiUrl())) {
            apiUrl = "https://" + ApiDomainOption.INSTANCE.getDEFAULT() + "/api/v3";
        } else {
            apiUrl = getApiUrl();
        }
        sb.append(apiUrl);
    ...
    public final String chapterCommentUrl(String chapterId) {
        Intrinsics.checkNotNullParameter(chapterId, "chapterId");
        return PreferencesKt.getHttpChapterCommentApiDomain(getPreferences()) + "/api/v3/roasts?limit=100&chapter_id=" + chapterId;
    }
