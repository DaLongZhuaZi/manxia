...
public final class ContentItem$$serializer implements GeneratedSerializer<ContentItem> {
    ...
    static {
        ...
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("eu.kanade.tachiyomi.extension.zh.copymanga.api.dto.ContentItem", contentItem$$serializer, 1);
    ...
    public ContentItem m28deserialize(Decoder decoder) throws UnknownFieldException {
        ...
        return new ContentItem(i, (String) objDecodeNullableSerializableElement, serializationConstructorMarker);
    }
    ...
    public void serialize(Encoder encoder, ContentItem value) {
        ...
        ContentItem.write$Self(value, compositeEncoderBeginStructure, descriptor2);
