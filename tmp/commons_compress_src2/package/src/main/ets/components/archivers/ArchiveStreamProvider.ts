...
export default interface ArchiveStreamProvider {

    createArchiveInputStream(name: string, inputStream: InputStream, encoding: string): ArchiveInputStream;

    createArchiveOutputStream(name: string, out: OutputStream, encoding: string): ArchiveOutputStream;
