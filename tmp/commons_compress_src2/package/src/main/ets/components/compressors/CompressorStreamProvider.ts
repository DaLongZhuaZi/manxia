...
export default interface CompressorStreamProvider {


    createCompressorNameInputStream(name: string, inputStream: InputStream,
                                    decompressUntilEOF?: boolean): CompressorInputStream;

    createCompressorOutputStream(name: string, out: OutputStream): CompressorOutputStream;
